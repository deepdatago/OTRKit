Pod::Spec.new do |s|
  ...
  s.ios.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(PODS_ROOT)/OTRKit/OTRKitDependencies-iOS/include', 'FRAMEWORK_SEARCH_PATHS' => '$(PODS_ROOT)/../Carthage/Build/iOS $(PODS_ROOT)/../../ChatSecure/Submodules/OTRKit/workaround/**' }
